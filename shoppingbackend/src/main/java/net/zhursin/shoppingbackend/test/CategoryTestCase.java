package net.zhursin.shoppingbackend.test;
...
import net.zhursin.shoppingbackend.dao.CategoryDAO;
...
public class CategoryTestCase {
	...
	public static void init() {
		...
		context.scan("net.zhursin.shoppingbackend");
		context.refresh();
	 ...
	 * 
	 * assertEquals("Successfully added a category inside the table!","Television",
	 * categoryDAO.getName());
	 * 
	 * }
	 */
